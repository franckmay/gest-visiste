    ...
    <div  class="row" >
      ...
      <div class="col-sm-8" >
        ...
        <p style="width: 678px;" id="col-1">Date :<?php echo $result['Date'];?>&nbsp;&nbsp;
          Heure d arrivee :&nbsp;<?php echo $result['TimeIN']?></p>
        <br>
     ...
     <p style="text-align:center;padding-top:20px;">NOTE : Ce badge visiteur n'est valable que x heures, merci de le rendre à la sortie !</p>
    <br>
    <br>
    <div style="text-align:center;"> <button type="button" id="button" class="hide-from-printer"
        onclick="window.print()" value="Print Badge">Imprimer Badge</button> <a type="button"
        id="button" class="hide-from-printer" href="front.php">retour </a></div>
