...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#" id = "li"><?php echo "Connecté sur : ".$user_;?></a>
    </div>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="front.php" id = "li">Accueil</a></li>
      <li class="active"><a  href="myform.php">Ajouter Visiteur</a></li>
...
<div style= "float:right; padding-right:8px;padding-top:10px;">
  <p id = "timeDisplay" > Heure : <span id="t1"></span>
</p>
...
<div style="margin-left:110px;padding-bottom:12px">
  ...
  <input autocomplete="off" class="form-control" type= "text" name ="name" placeholder= "Entrer le nom du visiteur." required id = "name"
...
<div class="form-group">
<label for="cno"> Telephone. :</label> <span id = "span" style = "padding-bottom: 5px;float:right;"></span>
 <input autocomplete="off" class="form-control" type="number" id = "ContactInfo" onkeyup = "Ccheck('ContactInfo')" 
	onblur = "isEmpty('ContactInfo')" onfocus = "onfo('ContactInfo')" name="cno" placeholder="Entrer numero de tel." 
...
<div class="row">
 <div class="col-sm-7">
  <div class="form-group">
   <label for = "meetingTo">Rendez-vous avec :</label>
